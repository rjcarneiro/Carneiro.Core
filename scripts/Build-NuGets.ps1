...
# tests
dotnet pack ./src/Carneiro.Core.Tests.Abstractions/Carneiro.Core.Tests.Abstractions.csproj -c $Configuration -p:Version=$Version --no-restore --nologo -o $Path 3>&1 2>&1 $null
...
dotnet pack ./src/Carneiro.Core.Web.Abstractions/Carneiro.Core.Web.Abstractions.csproj -c $Configuration -p:Version=$Version --no-restore --nologo -o $Path 3>&1 2>&1 $null
